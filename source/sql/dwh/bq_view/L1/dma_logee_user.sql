-- karena logee tracking sedang di hold maka assign_indicar dan show_tracking dapat diabaikan terlebih dahulu
...
WITH base as(
  ...
  FROM `logee-data-dev.L1_visibility.dma_logee_user`
)
