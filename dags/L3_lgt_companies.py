...
external_task = ExternalTaskSensor(
    task_id=f'wait_L2_visibility_dma_logee_companies',
    dag=dag,
    external_dag_id='L2_visibility_dma_logee_companies',
    external_task_id='move_L1_to_L2'
)

#  FACT_DMA_LOGEE_COMPANIES
fact_dma_logee_companies = BigQueryExecuteQueryOperator(
    task_id='L3_lgt_fact_companies',
    dag=dag,
    sql=get_sql_string(dags, 'source/sql/dwh/L3/lgt/fact_companies.sql'),
    destination_dataset_table='logee-data-prod.L3_lgt.fact_companies',
...
external_task >> fact_dma_logee_companies
