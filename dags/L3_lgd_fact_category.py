...
external_task = ExternalTaskSensor(
    task_id=f'wait_L2_visibility_lgd_category',
    dag=dag,
    external_dag_id='L2_visibility_lgd_category',
    external_task_id='move_L1_to_L2'
)

#  FACT_LGD_CATEGORY
fact_lgd_category = BigQueryExecuteQueryOperator(
    task_id='L3_lgd_fact_category',
    dag=dag,
    sql=get_sql_string(dags, 'source/sql/dwh/L3/lgd/fact_category.sql'),
    destination_dataset_table='logee-data-prod.L3_lgd.fact_category',
...
external_task >> fact_lgd_category
