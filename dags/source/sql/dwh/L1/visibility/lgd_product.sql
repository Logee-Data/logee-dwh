...
SELECT
  ...
  json_extract_scalar(original_data, '$.productStock') AS product_stock,
  json_extract_scalar(original_data, '$.productMinimumOrder') AS product_minimum_order,
  json_extract_scalar(original_data, '$.productVariant') AS product_variant,
