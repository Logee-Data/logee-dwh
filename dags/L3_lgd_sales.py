...
external_task = ExternalTaskSensor(
    task_id=f'wait_L2_visibility_lgd_sales',
    dag=dag,
    external_dag_id='L2_visibility_lgd_sales',
    external_task_id='move_L1_to_L2'
)

#  FACT_LGD_SALES
fact_lgd_sales = BigQueryExecuteQueryOperator(
    task_id='fact_sales',
    dag=dag,
    sql=get_sql_string(dags, 'source/sql/dwh/L3/lgd/fact_sales.sql'),
    destination_dataset_table='logee-data-prod.L3_lgd.fact_sales',
