...
external_task = ExternalTaskSensor(
    task_id=f'wait_L2_visibility_dma_logee_user',
    dag=dag,
    external_dag_id='L2_visibility_dma_logee_user',
    external_task_id='move_L1_to_L2'
)

#  FACT_DMA_LOGEE_USER
fact_dma_logee_user = BigQueryExecuteQueryOperator(
    task_id='L3_lgt_fact_user',
    dag=dag,
    sql=get_sql_string(dags, 'source/sql/dwh/L3/lgt/fact_user.sql'),
    destination_dataset_table='logee-data-prod.L3_lgt.fact_user',
...
external_task >> fact_dma_logee_user